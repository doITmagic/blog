...
var (
	pattern_Query_Params_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 1, 2, 2}, []string{"doitmagic", "blog", "params"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_Posts_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 1, 2, 2}, []string{"doitmagic", "blog", "posts"}, "", runtime.AssumeColonVerbOpt(true)))
)
