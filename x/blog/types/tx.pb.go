...
func init() {
	proto.RegisterType((*MsgCreatePost)(nil), "doitmagic.blog.blog.MsgCreatePost")
	proto.RegisterType((*MsgCreatePostResponse)(nil), "doitmagic.blog.blog.MsgCreatePostResponse")
}
...
var fileDescriptor_90382f40c04acbba = []byte{
	...
	0xd7, 0x2f, 0xa9, 0xd0, 0x2b, 0x28, 0xca, 0x2f, 0xc9, 0x17, 0x12, 0x4e, 0xc9, 0xcf, 0x2c, 0xc9,
	0x4d, 0x4c, 0xcf, 0x4c, 0xd6, 0x03, 0x49, 0x80, 0x09, 0xa5, 0x60, 0x2e, 0x5e, 0xdf, 0xe2, 0x74,
	...
	0x2a, 0x0b, 0x52, 0x8b, 0x93, 0xd8, 0xc0, 0x01, 0x68, 0x0c, 0x08, 0x00, 0x00, 0xff, 0xff, 0x86,
	0x41, 0x0b, 0xf6, 0x51, 0x01, 0x00, 0x00,
}
...
func (c *msgClient) CreatePost(ctx context.Context, in *MsgCreatePost, opts ...grpc.CallOption) (*MsgCreatePostResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/doitmagic.blog.blog.Msg/CreatePost", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_CreatePost_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/doitmagic.blog.blog.Msg/CreatePost",
	}
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "doitmagic.blog.blog.Msg",
