...
export const protobufPackage = "doitmagic.blog.blog";
...
export class QueryClientImpl {
    ...
    Params(request) {
        ...
        const promise = this.rpc.request("doitmagic.blog.blog.Query", "Params", data);
        return promise.then((data) => QueryParamsResponse.decode(new Reader(data)));
    }
    Posts(request) {
        const data = QueryPostsRequest.encode(request).finish();
        const promise = this.rpc.request("doitmagic.blog.blog.Query", "Posts", data);
